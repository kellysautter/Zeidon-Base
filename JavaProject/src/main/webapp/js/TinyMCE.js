...
tinyMCE.init({
   ...
   theme_advanced_buttons1 : "bold,italic,underline,forecolor,separator,strikethrough,fontsize,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,sub,sup,|,undo,redo,|,removeformat,paste,code", 
