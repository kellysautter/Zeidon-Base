 ...
 *
 */
public class DynamicTableDomainWContextAndLangNoSort extends DynamicTableDomain
{
	
    public DynamicTableDomainWContextAndLangNoSort(Application application, Map<String, Object> domainProperties, Task task )
    {
