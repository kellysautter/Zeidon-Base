 ...
 *
 */
public class FAISIR_DynamicTableSingle extends AbstractNumericDomain
{
    private final DecimalFormat parser = new DecimalFormat( "#,###.#" );

    public FAISIR_DynamicTableSingle( Application application, Map<String, Object> domainProperties, Task task )
    {
...
//        if ( name.equals( "DecimalFormat" ) )  Decimal format not needed.  See contexts.
    ...
    // TODO - talk DG about addToAttribute
    /*
    @Override
