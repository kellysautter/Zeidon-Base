/**
    ...
    It also sorts the domain values alphabetically in the domain list.
 ...
 *
 */
public class DynamicTableDomainSortA extends DynamicTableDomain
{
    public DynamicTableDomainSortA(Application application, Map<String, Object> domainProperties, Task task )
    {
    ...
    protected View activateApplicationDomain( Task task, DomainContext context )
    {
        ...
        // Order DomainValues, also for any context domainvalues.
